...
function connectUSB(){
  ...
  return new Promise((_2) => {
    _2(new Promise((_3) => {
      _3(globalThis.navigator.usb.requestDevice({filters:[]}).then((d) => d.open().then(() => d.selectConfiguration(1).then(() => d.claimInterface(0).then(() => {
        device().Set(d);
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static {
    this.statusMessage=_c_1.Create_1("Waiting for connection...");
    this.device=_c_1.Create_1(void 0);
  }
});
function NewGuid(){
