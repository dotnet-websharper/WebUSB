...
{
 "use strict";
 var WebSharper,WebUSB,Sample,Client,Operators,Obj,UI,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,TemplateHole,Var,Handler,Unchecked,WebSharper$WebUSB$Sample_Templates,TemplateHoleModule,Text,TextView,SC$1,System,Guid,EventQ,JavaScript,Pervasives,Concurrency,Promise,EventTarget,JS,Client$1,Templates,Doc,Collections,Dictionary,Node,Object,Var$1,WindowOrWorkerGlobalScope,AsyncBody,CT,HashSet,Seq,TemplateInitializer,VarStr,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,View,Numeric,ConcreteVar,Snap,Scheduler,Error,NonStandardPromiseRejectionException,SC$2,DictionaryUtil,Enumerator,T,SC$3,Docs,DocElemNode,CharacterData,Abbrev,Fresh,OperationCanceledException,CancellationTokenSource,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Attribute,Event,AttrModule,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Anims,SC$4,HashSetUtil,SC$5,SC$6,SC$7,AppendList,DynamicAttrNode,KeyNotFoundException,SC$8,Easing,HashSet$1,BindVar,String,CheckedInput,DomNodes,Char,DateUtil,Lazy,SC$9,Queue,LazyExtensionsProxy,LazyRecord,console,Promise$1,Runtime$1,Math,Date;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 WebUSB=WebSharper.WebUSB=WebSharper.WebUSB||{};
 Sample=WebUSB.Sample=WebUSB.Sample||{};
 ...
 WebSharper$WebUSB$Sample_Templates=Global.WebSharper$WebUSB$Sample_Templates=Global.WebSharper$WebUSB$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_WebUSB_Sample$Client=Global.StartupCode$WebSharper_WebUSB_Sample$Client||{};
 ...
 {
  var _,b,t,t$1,_this,p,i;
  _=(b=(t=(t$1=(_this=new ProviderBuilder.New$1(),(_this.h.push(new TextView.New("status",Client.statusMessage().get_View())),_this)),(t$1.h.push(Handler.EventQ2(t$1.k,"connectusb",function()
  {
   return t$1.i;
  },function()
  {
   var _$1;
   Concurrency.StartImmediate((_$1=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind(Promise.AsAsync(Client.connectUSB()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t$1)),(t.h.push(Handler.EventQ2(t.k,"sendusbdata",function()
  {
   return t.i;
  },function()
  {
   ...
   Concurrency.StartImmediate((_$1=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind(Promise.AsAsync(Client.sendUSBData()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$WebUSB$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Client.connectUSB=function()
 {
  ...
  function f()
  {
   function f$1()
   {
    return Client.usb().requestDevice({
     filters:[]
    }).then(function(a)
    {
     return a.open().then(function()
     {
      return a.selectConfiguration(1).then(function()
      {
       return a.claimInterface(0).then(function()
       {
        var $1;
        Client.device().Set(a);
        Client.statusMessage().Set("Connected to USB device: $"+Global.String(Client.device().Get().productName));
        $1=Client.device().Get();
        (function($2)
        {
         return $2("USB Device Connected: "+Global.String($1));
        }(function(s)
        {
         console.log(s);
        }));
   ...
   function f$2(a)
   {
    Client.statusMessage().Set("Connection Failed: "+Global.String(a.message));
    (function($1)
    {
     return $1("USB Connection Error: "+Global.String(a));
    }(function(s)
    {
     console.log(s);
    }));
 ...
 Client.sendUSBData=function()
 {
  ...
  function f()
  {
   ...
   {
    var data;
    data=Global["eval"]("new TextEncoder()").encode("Hello USB!");
    return Client.device().Get().transferOut(1,data).then(function()
    {
     Client.statusMessage().Set("Data sent to USB device.");
     (function($1)
     {
      return $1("Data sent: "+Global.String(data));
     }(function(s)
     {
      console.log(s);
     }));
   ...
   function f$2(a)
   {
    Client.statusMessage().Set("Data transfer failed: "+Global.String(a.message));
    (function($1)
    {
     return $1("USB Data Transfer Error: "+Global.String(a));
    }(function(s)
    {
     console.log(s);
    }));
   ...
   return Client.device().Get()==null?(Client.statusMessage().Set("Please connect a USB device first."),Promise$1.resolve(null)):new Promise$1(function($1)
   {
    $1(f$1());
   })["catch"](function(d)
   {
 ...
 WebSharper$WebUSB$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.statusMessage=Var$1.Create$1("Waiting for connection...");
  SC$1.device=Var$1.Create$1(void 0);
  SC$1.usb=self.navigator.usb;
 };
